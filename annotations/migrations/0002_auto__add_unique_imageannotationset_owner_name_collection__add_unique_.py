...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ImageAnnotationSet', fields ['owner', 'name', 'collection']
        db.create_unique('annotations_imageannotationset', ['owner_id', 'name', 'collection_id'])

        # Adding unique constraint on 'PointAnnotationSet', fields ['owner', 'name', 'collection']
        db.create_unique('annotations_pointannotationset', ['owner_id', 'name', 'collection_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PointAnnotationSet', fields ['owner', 'name', 'collection']
        db.delete_unique('annotations_pointannotationset', ['owner_id', 'name', 'collection_id'])

        # Removing unique constraint on 'ImageAnnotationSet', fields ['owner', 'name', 'collection']
        db.delete_unique('annotations_imageannotationset', ['owner_id', 'name', 'collection_id'])
