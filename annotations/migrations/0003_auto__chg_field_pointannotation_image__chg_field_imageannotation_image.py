...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PointAnnotation.image'
        db.alter_column('annotations_pointannotation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Image']))

        # Changing field 'ImageAnnotation.image'
        db.alter_column('annotations_imageannotation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Image']))

    def backwards(self, orm):

        # Changing field 'PointAnnotation.image'
        db.alter_column('annotations_pointannotation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Pose']))

        # Changing field 'ImageAnnotation.image'
        db.alter_column('annotations_imageannotation', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catamidb.Pose']))
