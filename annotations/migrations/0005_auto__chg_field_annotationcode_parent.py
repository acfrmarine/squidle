...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnnotationCode.parent'
        db.alter_column('annotations_annotationcode', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.AnnotationCode'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AnnotationCode.parent'
        raise RuntimeError("Cannot reverse this migration. 'AnnotationCode.parent' and its values cannot be restored.")
    ...
    models = {
        'annotations.annotationcode': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['annotations.AnnotationCode']", 'null': 'True', 'blank': 'True'}),
