...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnnotationCode.cpc_code'
        db.alter_column(u'annotations_annotationcode', 'cpc_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=6))

        # Changing field 'AnnotationCode.caab_code'
        db.alter_column(u'annotations_annotationcode', 'caab_code', self.gf('django.db.models.fields.CharField')(max_length=8, unique=True, null=True))
        # Adding field 'PointAnnotation.mtime'
        db.add_column(u'annotations_pointannotation', 'mtime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PointAnnotation.ctime'
        db.add_column(u'annotations_pointannotation', 'ctime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ImageAnnotation.mtime'
        db.add_column(u'annotations_imageannotation', 'mtime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageAnnotation.ctime'
        db.add_column(u'annotations_imageannotation', 'ctime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 3, 6, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AnnotationCode.cpc_code'
        db.alter_column(u'annotations_annotationcode', 'cpc_code', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True))

        # User chose to not deal with backwards NULL issues for 'AnnotationCode.caab_code'
        raise RuntimeError("Cannot reverse this migration. 'AnnotationCode.caab_code' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AnnotationCode.caab_code'
        db.alter_column(u'annotations_annotationcode', 'caab_code', self.gf('django.db.models.fields.CharField')(max_length=8, unique=True))
        # Deleting field 'PointAnnotation.mtime'
        db.delete_column(u'annotations_pointannotation', 'mtime')

        # Deleting field 'PointAnnotation.ctime'
        db.delete_column(u'annotations_pointannotation', 'ctime')

        # Deleting field 'ImageAnnotation.mtime'
        db.delete_column(u'annotations_imageannotation', 'mtime')

        # Deleting field 'ImageAnnotation.ctime'
        db.delete_column(u'annotations_imageannotation', 'ctime')
