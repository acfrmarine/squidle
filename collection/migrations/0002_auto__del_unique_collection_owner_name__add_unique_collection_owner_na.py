...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Collection', fields ['owner', 'name', 'parent']
        db.create_unique('collection_collection', ['owner_id', 'name', 'parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Collection', fields ['owner', 'name', 'parent']
        db.delete_unique('collection_collection', ['owner_id', 'name', 'parent_id'])
