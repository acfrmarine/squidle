...
function prependInfoMsg(el) {
    if (!curstate.asid)
        $(el).prepend('<div class="alert alert-danger"><b>WARNING:</b> no Annotation run selected. To select/create an annotation run, click <a href="#dataset-modal" data-toggle="modal">here</a> or click the "DATA" button on the top bar.</div>');
}
