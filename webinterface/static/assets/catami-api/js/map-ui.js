...
//        });
    ...
    this.addBBoxSelect = function ($container, $infocontainer,layername) {
        ...
        var $bboxdraw = $('<button type="button" id="bboxdraw" class="btn btn-group btn-group-sm" title="Draw a bounding box around the images you would like to add to your selection."><i class="icon-crop"></i> Create</button>'),
			$bboxedit = $('<button type="button" id="bboxedit" class="btn btn-group btn-group-sm" title="Edit a bounding box by selecting it."><i class="icon-edit"></i> Edit</button>'),
			$bboxdel  = $('<button type="button" id="bboxdel"  class="btn btn-group btn-group-sm" title="Delete a bounding box by selecting it."><i class="icon-remove-sign"></i> Delete</button>');
